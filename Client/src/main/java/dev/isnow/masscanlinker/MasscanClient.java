...
import dev.isnow.masscanlinker.server.ServerThread;
...
public class MasscanClient {
    private static MasscanClient instance;
    ...
    public MasscanClient(String[] args) {
        instance = this;
        if(args.length == 0) {
    ...
    public static MasscanClient getInstance() {
        return instance;
    }
}